...
// function video() {
//   let videos = document.querySelectorAll('.modal__videos');
//   let modalOverlayVideo = document.querySelectorAll('.modal-overlay-video');
...
//   videos.forEach((elem) => {
//     let videoHref = elem.dataset.video;
//     // console.log(videoHref);

//     let deletedLength = 'https://www.youtube.com/embed/'.length;
